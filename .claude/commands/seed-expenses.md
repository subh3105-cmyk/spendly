...
If any argument is missing or not a valid integer, stop and provide a helpful guide:
...
- `<count>`: Total number of random expenses to generate.
- `<months>`: Time window in months to spread expenses over.
